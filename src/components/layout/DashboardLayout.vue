  ...
  <div class="min-h-screen bg-gray-50 flex">
    ...
    >
      ...
      <div class="flex items-center justify-between p-5 border-b border-gray-200">
        ...
        <button
          @click="toggleSidebar"
          class="touch-target p-2 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors duration-200"
      ...
      <nav class="flex-1 p-5">
        <!-- Main Section -->
        <div class="space-y-2">
          <div v-if="!sidebarCollapsed" class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">
            Main
          </div>
        ...
        <div class="mt-8 space-y-2">
          ...
          >
            ...
            <span v-if="!sidebarCollapsed" class="ml-3">Organizations</span>
          </router-link>
          ...
          <router-link
            ...
            :class="[
              'nav-item',
              $route.path.startsWith('/interactions')
                ? 'nav-item-active'
                : 'nav-item-inactive'
            ]"
          >
        ...
        <div v-if="!sidebarCollapsed" class="mt-8 pt-6 border-t border-gray-200">
